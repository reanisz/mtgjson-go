...
type Set struct {
	...
	Basesetsize      sql.NullInt64  `json:"baseSetSize" db:"baseSetSize"`           // baseSetSize
	Block            sql.NullString `json:"block" db:"block"`                       // block
	Booster          sql.NullString `json:"booster" db:"booster"`                   // booster
...
func SetByID(db XODB, id sql.NullInt64) (*Set, error) {
	var err error
