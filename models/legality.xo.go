...
type Legality struct {
	...
	Format sql.NullString `json:"format" db:"format"` // format
	Status sql.NullString `json:"status" db:"status"` // status
	UUID   sql.NullString `json:"uuid" db:"uuid"`     // uuid
...
func LegalityByID(db XODB, id sql.NullInt64) (*Legality, error) {
	var err error
